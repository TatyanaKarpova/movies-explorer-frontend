...
function SearchForm({handleSearchMovie}) {
  ...
  return (
    <section className="search-form">
      <form className="search-form__form" onSubmit={handleSearchMovieSubmit} autoComplete="off" noValidate>
        ...
        <span className={error ? "search-form__error" : "search-form__error_hidden"}>{error}</span>
      </form>
